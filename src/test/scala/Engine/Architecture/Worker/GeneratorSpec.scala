...
class GeneratorSpec
  ...
  "A Generator" should "be able to set a conditional breakpoint and trigger it" in {
    ...
    system.log.info("received bad tuple: {}",tmp2.asInstanceOf[ConditionalBreakpoint].badTuple)
    ...
    system.log.info("received bad tuple: {}",tmp3.asInstanceOf[ConditionalBreakpoint].badTuple)
